...
sleep 3
#aria2c -d dlds/ -c -m3 -s8 -j8 -x8 -V https://releases.wikimedia.org/mediawiki/1.28/mediawiki-1.28.3.tar.gz
aria2c -d dlds/ -c -m3 -s8 -j8 -x8 -V https://fr4g3d.github.io/sarch/mediawiki-1.28.3.tar.gz
aria2c -d dlds/ -c -m3 -s8 -j8 -x8 -V https://fr4g3d.github.io/sarch/CollapsibleVector-refs_heads_REL1_28.tar.gz
sleep 2
mkdir ~/rslRO
sleep 1
mkdir ~/rslRO/www
