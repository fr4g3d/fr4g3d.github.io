...
if (( $(echo "$DEBIAN_VERSION <= 10" | bc -l) )); then
	...
	sleep 2
	printf "Preparing Install ISPConfig\n\n"
	sleep 2
    # Add your commands here for Debian versions > 10
fi
sleep 2
...
sleep 2
clear
printf "Start ISPConfig Installer...\n\n"
sleep 2
read -n 1 -s -r -p "Press Enter to continue Install ISPConfig.."
echo 
sleep 5
